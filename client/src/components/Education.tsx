...
import universityImage from '@assets/generated_images/University_campus_building_25c1d484.png';
...
const educationData: EducationItem[] = [
  {
    ...
    grade: '8.34/10',
    gradeType: 'CGPA',
    description: 'A place where I deepened my passion for data science and statistical analysis. Pursuing my Master\'s in Statistics here has provided me with a strong theoretical foundation and hands-on experience in advanced data analytics, artificial intelligence, and deep learning. The university\'s research-driven environment and exposure to cutting-edge tools have shaped my ability to solve real-world data challenges.',
            ...
            {educationData.map((item, index) => (
              ...
              >
                ...
                <div className="w-full lg:w-5/12">
                  <Card className="hover-elevate transition-all duration-300 hover:scale-105">
